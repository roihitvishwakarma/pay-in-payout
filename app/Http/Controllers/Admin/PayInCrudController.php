...
use App\Http\Requests\PayInCrudRequest;
use App\Models\Merchant;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Admin CRUD for pay-in records.
 *
...
class PayInCrudController extends CrudController
{
    ...
    public function setup(): void
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/pay-in');
    ...
    {
        CRUD::setValidation(PayInCrudRequest::class);
